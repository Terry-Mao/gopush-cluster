...
| "Get Subscription Node":ServerGet | /server/get | GET |
| "Get Offline Messages":MsgGet    | /msg/get    | GET |
...
Note:
* Every message is a string rather than struct, so you need to Unmarshal message one by one
* The type of parameter "mid" is int64.
...
[ServerGet]#GetSubscriptionNode
[MsgGet]#GetOfflineMessages
