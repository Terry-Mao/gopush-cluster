...
| "Push Private Message":AdminPush | /admin/push     | POST |
| "Push Public Message":AdminPushPublic | /admin/push/public     | POST |
| "Add Node":AdminNodeAdd | /admin/node/add | POST |
| "Delete Node":AdminNodeDel | /admin/node/del | POST |
| "Clean Message":AdminMsgClean | /admin/msg/clean | POST |
...
[AdminPush]#Push Private Message
[AdminPushPublic]#Push Public Message
[AdminNodeAdd]#Add Node
[AdminNodeDel]#Delete Node
[AdminMsgClean]#Clean Message
