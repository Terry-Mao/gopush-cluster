...
| "<a href="#Push Private Message">Push Private Message</a>":AdminPush | /1/admin/push/private     | POST |
| "<a href="#Clean Message">Clean Message</a>":AdminMsgClean | /1/admin/msg/del | POST |
...
Note: Messages stored in body and must be json format, service will wholly intact return to client. Above just as URL Parameter.
